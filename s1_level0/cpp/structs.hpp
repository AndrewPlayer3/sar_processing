...
const vector<unordered_map<u_int16_t, u_int8_t>> BRC_TO_HUFFMAN_CODING = {
    ...
    {{0, 0}, {2, 1}, {6, 2}, {14, 3}, {30, 4}, {62, 5}, {63, 6}},
    {{0, 0}, {1, 1}, {2, 2}, {6, 3}, {14, 4}, {30, 5}, {62, 6}, {126, 7}, {254, 8}, {255, 9}},
    {{0, 0}, {2, 1}, {3, 2}, {4, 3}, {5, 4}, {12, 5}, {13, 6}, {14, 7}, {30, 8}, {62, 9}, {252, 10}, {253, 11}, {508, 12}, {509, 13}, {510, 14}, {511, 15}}
};
...
const float THIDX_TO_SF_ARRAY[256] = {
    0.00, 0.63, 1.25, 1.88, 2.51, 3.13, 3.76, 4.39, 5.01, 5.64, 6.27, 6.89, 7.52, 8.15, 8.77, 9.40,
    10.03, 10.65, 11.28, 11.91, 12.53, 13.16, 13.79, 14.41, 15.04, 15.67, 16.29, 16.92, 17.55, 18.17,
    18.80, 19.43, 20.06, 20.68, 21.31, 21.93, 22.56, 23.19, 23.81, 24.44, 25.06, 25.69, 26.32, 26.94,
    27.57, 28.20, 28.83, 29.45, 30.08, 30.71, 31.33, 31.96, 32.59, 33.21, 33.84, 34.47, 35.09, 35.72,
    36.35, 36.97, 37.60, 38.23, 38.85, 39.48, 40.11, 40.73, 41.36, 41.99, 42.61, 43.24, 43.87, 44.49,
    45.12, 45.75, 46.37, 47.00, 47.63, 48.25, 48.88, 49.51, 50.13, 50.76, 51.39, 52.01, 52.64, 53.27,
    53.89, 54.52, 55.15, 55.77, 56.40, 57.03, 57.65, 58.28, 58.91, 59.54, 60.16, 60.79, 61.41, 62.04,
    62.98, 64.24, 65.49, 66.74, 68.00, 69.25, 70.50, 71.76, 73.01, 74.26, 75.52, 76.77, 78.02, 79.28,
    80.53, 81.78, 83.04, 84.29, 85.54, 86.80, 88.05, 89.30, 90.56, 91.81, 93.07, 94.32, 95.57, 96.83,
    98.08, 99.33, 100.58, 101.84, 103.09, 104.34, 105.60, 106.85, 108.10, 109.36, 110.61, 111.86, 113.11,
    114.37, 115.62, 116.87, 118.13, 119.38, 120.63, 121.89, 123.14, 124.39, 125.65, 126.90, 128.15, 129.41,
    130.66, 131.91, 133.17, 134.42, 135.67, 136.93, 138.18, 139.43, 140.69, 141.94, 143.19, 144.45, 145.70,
    146.95, 148.21, 149.46, 150.71, 151.97, 153.22, 154.47, 155.73, 156.98, 158.23, 159.49, 160.74, 161.99,
    163.25, 164.50, 165.75, 167.01, 168.26, 169.51, 170.77, 172.02, 173.27, 174.53, 175.78, 177.03, 178.29,
    179.54, 180.79, 182.05, 183.30, 184.55, 185.81, 187.06, 188.31, 189.57, 190.82, 192.07, 193.33, 194.58,
    195.83, 197.09, 198.34, 199.59, 200.85, 202.10, 203.35, 204.61, 205.86, 207.11, 208.37, 209.62, 210.87,
    212.13, 213.38, 214.63, 215.89, 217.14, 218.39, 219.65, 220.90, 222.15, 223.41, 224.66, 225.91, 227.17,
    228.42, 229.67, 230.93, 232.18, 233.43, 234.69, 235.94, 237.19, 238.45, 239.70, 240.95, 242.21, 243.46,
    244.71, 245.97, 247.22, 248.47, 249.73, 250.98, 252.23, 253.49, 254.74, 255.99, 255.99
};


// Table 3.2-4 from Page 19
const vector<string> ECC_CODE_TO_SENSOR_MODE = {
    "contingency", "stripmap_1", "stripmap_2", "stripmap_3", "stripmap_4", "stripmap_5n", "stripmap_6", "contingency",
    "interferomatric_wide_swath", "wave_mode", "stripmap-5s", "stripmap_1_w_cal", "stripmap_2_w_cal", "stripmap_3_w_cal",
    "stripmap_4_w_cal", "rf_characterization_mode", "test_mode", "elevation_notch_s3", "azimuth_notch_s1", "azimuth_notch_s2",
    "azimuth_notch_s3", "azimuth_notch_s4", "azimuth_notch_s5n", "azimuth_notch_s5s", "azimuth_notch_s6", "stripmap_5n_wo_cal",
    "stripmap_5s_wo_cal", "stripmap_6_wo_cal", "contingency", "contingency", "contingency", "elevation_notch_s3_wo_cal",
    "extra_wide_swath", "azimuth_notch_s1_wo_cal", "azimuth_notch_s2_wo_cal", "azimuth_notch_s3_wo_cal", "contingency",
    "noise_characterization_s1", "noise_characterization_s2", "noise_characterization_s3", "noise_characterization_s4",
    "noise_characterization_s5n", "noise_characterization_s5s", "noise_characterization_s6", "noise_characterization_ew",
    "noise_characterization_iw", "noise_characterization_wave", "contingency"
};
